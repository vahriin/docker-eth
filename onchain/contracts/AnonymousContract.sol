...
contract AnonymousContract {
    ...
    constructor(
        ...
        // visibiility won't be needed in 7.0
    ...
    function register(
        ...
        uint256 challenge =
            uint256(keccak256(abi.encode(address(this), y, K))).mod();
    ...
    function fund(Utils.G1Point memory y, uint256 bTransfer) public {
        ...
        require(
            coin.transferFrom(msg.sender, address(this), bTransfer),
            "Transfer from sender failed."
        );
        require(
            coin.balanceOf(address(this)) <= MAX,
            "Fund pushes contract past maximum value."
        );
    }
    ...
    function transfer(
        ...
        pending[beneficiaryHash][0] = pending[beneficiaryHash][0].add(
            Utils.g().mul(fee)
        );
    ...
    function burn(
        ...
        require(
            coin.transfer(msg.sender, bTransfer),
            "This shouldn't fail... Something went severely wrong."
        );
    }
}
